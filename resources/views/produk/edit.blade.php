        ...
        <div class="col-md-4">
            <form action="/produk/{{ $produk->id }}/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="id_produk" class="form-control" id="id_produk" aria-describedby="emailHelp"
                        readonly value="{{ $produk->id_produk }}" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="distributor" class="form-control" id="distributor"
                        value="{{ $produk->distributor }}" required>
                </div>

                <div class="mb-3">
                    <label for="brand" class="form-label">Brand</label>
                    <input type="text" name="brand" class="form-control" id="brand" value="{{ $produk->brand }}"
                        required>
                </div>
