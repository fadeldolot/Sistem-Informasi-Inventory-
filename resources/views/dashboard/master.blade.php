                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" style="background-color: #e44c46" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            @if (auth()->user()->role=='admin')
                            <a class="nav-link collapsed"  style="color:rgb(240, 234, 234) " data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    @if (auth()->user()->role=='admin')
                                         <a class="nav-link" style="color: rgb(240, 234, 234)" href="/distributor">Data Distributor</a>  
                                    @endif
                                    @if (auth()->user()->role=='admin')
                                        <a class="nav-link" style="color: rgb(240, 234, 234)" href="/data_penjualan">Penjualan Produk</a>
                                    @endif
                                </nav>
                            </div>

                            @if (auth()->user()->role=='admin')
                            <a class="nav-link collapsed" style="color:rgb(240, 234, 234)"  data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link collapsed" style="color: rgb(240, 234, 234)"  href="/data_penjualan/printpdf">
                                        Cetak Laporan Penjualan
                                    </a>
                                    <a class="nav-link collapsed" style="color: rgb(240, 234, 234)"  href="/produk/printpdf">
